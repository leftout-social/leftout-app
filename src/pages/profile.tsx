...
const Profile = () => {
    ...
    return (
        <Parent>
            ...
            <Toolbar onBackClick={() => router.push('/')} onRightButtonClick={logout} rightButtonJSX={<LogoutIcon color='error'/>} />
            </div>
            <div className='scroll-container'>
            <ProfileComponent
                currentCity={userData?.current_city}
                gender={userData?.gender}
                firstName={userData?.first_name} lastName={userData?.last_name} age={userData?.age}/>
            </div>
